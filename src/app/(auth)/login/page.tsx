...
export default function LoginPage() {
  ...
  const getRedirectUrl = async () => {
    ...
    return role === "BUSINESS" ? "/dashboard/business" : "/dashboard/creator";
  };
  ...
  return (
    <div className="space-y-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-text-secondary">Sign in to your SYNQ account</p>
      </div>
      ...
      <Card className="p-6">
        ...
        <Button
          variant="outline"
          className="w-full"
          onClick={() => signIn("google", { callbackUrl: callbackUrl ?? "/api/auth/role-redirect" })}
        >
